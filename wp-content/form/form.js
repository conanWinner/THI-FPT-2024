...
var hanldeButtonGetData = function () {
  $("#BtnGetDataSelected").on("click", function (e) {
    ...
    $("#DataText").append(
      "<li>Tỉnh/Thành Phố: <strong>" + data.ProvinceText + "</strong></li>"
    );
    $("#DataText").append(
      "<li>Quận/Huyện: <strong>" + data.DistrictText + "</strong></li>"
    );
    $("#DataText").append(
      "<li>Xã/Phường: <strong>" + data.WardText + "</strong></li>"
    );

    $("#DataId").append(
      "<li>Province Id: <strong>" + data.ProvinceId + "</strong></li>"
    );
    $("#DataId").append(
      "<li>District Id: <strong>" + data.DistrictId + "</strong></li>"
    );
    $("#DataId").append(
      "<li>Ward Id: <strong>" + data.WardId + "</strong></li>"
    );
  });
};
